...
Shader "ASESampleShaders/SimpleTexture"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = tex2D( _Normals, uv_Normals ).xyz;
			float2 uv_Albedo = i.uv_texcoord * _Albedo_ST.xy + _Albedo_ST.zw;
			float4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
			o.Albedo = tex2DNode1.xyz;
			o.Emission = tex2DNode1.xyz;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=10001
2041;88;1478;839;1112.798;482.5021;1.3;True;True
Node;AmplifyShaderEditor.SamplerNode;1;-615.4003,-302.1997;Float;True;Property;_Albedo;Albedo;-1;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SamplerNode;5;-552.6003,50.49994;Float;True;Property;_Normals;Normals;-1;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=7A057E90D1D8E3E61E96C2133DCB2AF06615AFF5